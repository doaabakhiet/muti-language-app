...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark  text-light fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand text-success" href="javascript:void(0)">@lang('words.websiteName')</a>
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link" href="#qst">@lang('words.Questions')</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#instructors">@lang('words.Instructors')</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#contact">@lang('words.Contact')</a>
              </li>
              <li class="nav-item">
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @lang('words.ChooseLanguage')
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                      <a href="{{url('locale/ar')}}" class="dropdown-item" >عربى</a>
...
<section class="bg-dark text-light p-5 text-center text-sm-start p-lg-0 pt-lg-5">
  ...
  <div class="container">
      <div class="d-sm-flex ">
          <div class="m-lg-5">
            <h1 class="m-1">@lang('words.OnlineCourses') <span class="text-success"> For Free</span></h1>
            <p class="my-4">@lang('words.ProfessionalContentandInstructor')</p>
              ...
              <div class="col-md p-3">
                  <div class="card bg-dark text-light">
                    <div class="card-body text-center">
                      ...
                      <h3 class="text-success">javascript</h3>
                      <p class="card-text">
            ...
            <div class="col-md p-3">
              <div class="card bg-dark text-light">
                <div class="card-body text-center">
                  ...
                  <h3 class="text-success">Python</h3>
                  <p class="card-text">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur
                  </p>
                  <a href="#" class="btn btn-success">Read More</a>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md p-5">
              <h2 class="text-success">Learn The Fundamentals</h2>
              <p class="lead text-warning">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis praesentium fugiat labore nemo sed. A, unde! Inventore odit, illo assumenda sed sequi amet neque ullam et quia recusandae itaque minima. Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio accusamus velit sed voluptates explicabo quaerat fugiat illo quae sapiente doloremque. Ipsam sit quisquam aut eligendi consectetur ab possimus dolorem animi.</p>
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Excepturi nobis veritatis velit magnam in id, nostrum necessitatibus nihil autem molestiae iusto delectus blanditiis laborum reiciendis asperiores fugiat beatae ab natus.</div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo">
                  Where ara you exactly located
                </button>
              </h2>
              <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa incidunt sint consequuntur quasi, alias dignissimos atque porro qui magnam nihil, fuga sapiente sit! Quam voluptates aperiam sequi, excepturi fugiat nulla?</div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" >
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" >
                  Whar do i need to now ?
                </button>
              </h2>
              <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias illo rerum qui placeat maiores nobis itaque deleniti ea aut nostrum, repellendus, autem iure reprehenderit laboriosam deserunt fugiat ratione exercitationem accusamus.</div>
              </div>
            </div>
          </div>
          <!--accordion-->
